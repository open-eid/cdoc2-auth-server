...
public class AuthProcessEntity {
    ...
    @OneToMany(mappedBy = "authProcess")
    private List<AuthProcessCssSessionNonceEntity> cssSessionNonce;

    @OneToOne(mappedBy = "authProcess")
    private AuthProcessRpSessionNonceEntity rpSessionNonce;
}
